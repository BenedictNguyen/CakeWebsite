...
import ContactMessages from '../../backend/AllContent/ContactMessages/ContactMessages';
...
const AdminScreen = () => {
    ...
    return (
        <div className="container">
                    ...
                    <li className="menuItem">
                        ...
                        {activeMenu === 'gioiThieu' && (
                            <ul className="submenu">
                                ...
                                <li>
                                    <button onClick={() => handleToggleClick('contactMessages')}>Liên hệ</button>
                                </li>
                            </ul>
                        )}
                    </li>
            ...
            {activeMenu === 'contactMessages' && (
                <div className="formContainer">
                    <h2>Xem Bài Viết</h2>
                    <ContactMessages posts={posts} />
                </div>
            )}
        </div>
    );
